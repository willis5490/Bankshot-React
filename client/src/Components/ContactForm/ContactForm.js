    ...
    return (
      <div className="uk-container uk-animation-scale-up uk-transform-origin-top-right">
       <div className="uk-section">
         ...
         <h3 className='contactHeader uk-text-center contacth2 uk-margin-remove'>{this.props.contactText}</h3>

         <h4 id='formheader'>Fill out all of your information below.</h4>
