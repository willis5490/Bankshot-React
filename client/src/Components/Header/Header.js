       ...
       <nav id="headies" className="uk-navbar-container uk-margin uk-margin-auto uk-margin-auto-vertical" uk-navbar='true' uk-navbar="mode: click" >
            ...
            <div className="uk-navbar-center uk-visible@m">
                ...
                <li>
                    ...
                    <li className=""><a id="mobile-links" target="_blank" href="https://www.facebook.com/bankshotband/events"><b><i>Shows</i></b></a></li>
                     
                </ul>
            </div>
            <div style={{paddingRight:'20px'}} className="uk-navbar-right uk-visible@m">
                <ul class="uk-navbar-nav">
                    <li class="uk-active"> <a style={{color:'black'}} className='headerButtons' target="_blank" href="https://www.instagram.com/bankshotco/"><i class="fab fa-instagram fa-2x"></i></a></li>
                    <li class="uk-active"><a style={{color:'black'}} className='headerButtons' target="_blank" href="https://www.facebook.com/bankshotband"><i class="fab fa-facebook-square fa-2x"></i></a></li>
                    <li class="uk-active"><a style={{color:'black'}} className='headerButtons' target="_blank" href="https://m.soundcloud.com/bankshotco"><i class="fab fa-soundcloud fa-2x"></i></a></li>                   
                </ul>
            </div>
                            ...
                            <div className="uk-offcanvas-bar">
                                <ul className="uk-nav uk-nav-default">
                                    <li className="uk-nav-header">
                                        ...
                                        <img  className="uk-margin-small-right" id="logoimage" src="./css/images/bankshotphoto.JPG" alt="Bankshot music band logo"width="100" height="75"  ></img>
                                    </li>
                                    ...
                                    <li className=""><a style={{color:'black', fontSize:'20px', fontFamily:"'Cardo', serif", fontWeight:'700'}} target="_blank" href="https://www.facebook.com/bankshotband/events">Shows</a></li>              
            ...
            <div className="uk-navbar-center uk-hidden@m">
                <img id='' className="" src="../images/logo-big.png" width="50" height="50" alt=''></img>
            </div>
        </nav>
      </div>
        </div>
