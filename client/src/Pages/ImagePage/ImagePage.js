            ...
            <div uk-grid='true'>
             ...
             <div  className='uk-grid-match' uk-grid='true'>
                <div className='uk-width-1-2@m uk-width-1-1'>
                  <img className='imagesMobile uk-margin-medium-bottom'src={this.state.images[0]}></img>
                  <img className='imagesMobile'src={this.state.images[1]}></img>
                </div>
                <div className='uk-width-1-2@m uk-width-1-1 '>
                  <img className='imagesMobile'src={this.state.images[2]}></img>
                </div>
                ...
                <div className=' uk-width-1-1'>
                  <img className='imagesMobile uk-margin-medium-bottom'src={this.state.images[9]}></img>
                </div>
