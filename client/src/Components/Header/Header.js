                    ...
                    <nav id="headies" className="uk-navbar-container uk-margin uk-margin-auto uk-margin-auto-vertical" uk-navbar='true' uk-navbar="mode: click" >
                        ...
                        <div style={{ paddingRight: '20px' }} className="uk-navbar-right uk-visible@m">
                            <ul class="uk-navbar-nav">
                                <li class="uk-active"> <a style={{ color: 'black' }} className='headerButtons' target="_blank" href="https://www.instagram.com/bankshotco/"><i class="fab fa-instagram fa-3x"></i></a></li>
                                <li class="uk-active"><a style={{ color: 'black' }} className='headerButtons' target="_blank" href="https://www.facebook.com/bankshotband"><i class="fab fa-facebook-square fa-3x"></i></a></li>
                        ...
                        <div className="uk-navbar-right uk-hidden@m">
                            <ul className="uk-navbar-nav">
                                <li class="uk-active"> <a style={{ color: 'black' }} className='' target="_blank" href="https://www.instagram.com/bankshotco/"><i class="fab fa-instagram fa-2x"></i></a></li>
                                <li class="uk-active"><a style={{ color: 'black' }} className='mobileSocialMediaHeaderIcons' target="_blank" href="https://www.facebook.com/bankshotband"><i class="fab fa-facebook-square fa-2x"></i></a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
